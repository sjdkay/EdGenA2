...
// Sat Jul 11 14:14:04 2015 by ROOT version 5.34/18
// from TChain h1/
//////////////////////////////////////////////////////////

#ifndef new_analysis_h
#define new_analysis_h
...
class new_analysis : public TSelector {
public :
  TH1F            *h1_vz;
  TH1F            *h1_E;
  TH1F            *h1_masspi0;
  TH1F            *h1_mass2gamma;
   ...
   new_analysis(TTree * /*tree*/ =0) : fChain(0) { }
   virtual ~new_analysis() { }
   ...
   ClassDef(new_analysis,0);
};

#endif

#ifdef new_analysis_cxx
void new_analysis::Init(TTree *tree)
{
