#define analysis_6_cxx
// The class definition in analysis_6.h has been generated automatically
...
//
// Root > T->Process("analysis_6.C")
// Root > T->Process("analysis_6.C","some options")
// Root > T->Process("analysis_6.C+")
//

#include "analysis_6.h"
#include <TH2.h>
#include <TStyle.h>


void analysis_6::Begin(TTree * /*tree*/)
{
...
void analysis_6::SlaveBegin(TTree * /*tree*/)
{
...
Bool_t analysis_6::Process(Long64_t entry)
{
   // The Process() function is called for each entry in the tree (or possibly
   // keyed object in the case of PROOF) to be processed. The entry argument
   // specifies which entry in the currently loaded tree is to be processed.
   // It can be passed to either analysis_6::GetEntry() or TBranch::GetEntry()
  ...
  TLorentzVector p_a2(px[1],py[1],pz[1],Ef[1]);
...
void analysis_6::SlaveTerminate()
{
...
void analysis_6::Terminate()
{
   // The Terminate() function is the last function to be called during
   // a query. It always runs on the client, it can be used to present
   // the results graphically or save the results to file.

  TFile file_out("analysis_6_output.root","recreate");
